...
OBJECTS = trace.o matrix.o lodepng.o shade.o hashtable.o linkedlist.o texture.o cmd.o xwin.o halton.o primitives.o
PROGRAM = trace.exe
...
primitives.o : primitives.c primitives.h
	$(CC) -c primitives.c -o primitives.o $(OPTIONS)
